<form method="post" action="#tabs-2">
    <div class="form-table">
        ...
        <input type="text" name="Registrant_FirstName"
               value="<?php echo isset($_POST['Registrant_FirstName']) ? $_POST['Registrant_FirstName'] : '' ?>"
               required><br>
        Last name:<br>
        ...
        <input type="tel" name="registrant_phonenumber" placeholder="Format: 1.9999999999"
               value="<?php echo isset($_POST['registrant_phonenumber']) ? $_POST['registrant_phonenumber'] : '' ?>"
               required><br>
        Street:<br>
        ...
        <input type="text"
               ...
               value="<?php echo isset($_POST['registrant_city']) ? $_POST['registrant_city'] : '' ?>" required
        "><br>
        ...
        <input type="text" maxlength="2" size="2" placeholder="VA"
               ...
               value="<?php echo isset($_POST['registrant_state']) ? $_POST['registrant_state'] : '' ?>" required
        "><br>
        Postal Code:<br>
        <input type="number"
    ...
    <?php submit_button('Register The Domain'); ?>
