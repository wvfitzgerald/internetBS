        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input type="text" name="internet_api_key" value="<?php echo esc_attr( get_option('internet_api_key') ); ?>" /></td>
                </tr>

                <tr valign="top">
                    <th scope="row">Password</th>
                    <td><input type="text" name="internet_pass" value="<?php echo esc_attr( get_option('internet_pass') ); ?>" /></td>
                </tr>
            </table>
